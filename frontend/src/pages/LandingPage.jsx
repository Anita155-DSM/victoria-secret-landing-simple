...
const LandingPage = () => {
    ...
    if (loading) {
        return (
            <div className="landing-container" style={{ textAlign: 'center', padding: '100px' }}>
                ...
                <div className="product-showcase">
                    ...
                    <div className="product-details">
                        ...
                        <div className="price-section">
                            ...
                            <span className="old-price">${(selectedProduct.price * 1.15).toLocaleString("es-AR")}</span>
                            <span className="new-price">${selectedProduct.price.toLocaleString("es-AR")} ARS</span>
                        ...
                        <div className="fragrance-selector">
                            ...
                            <div className="selector-buttons">
                                {getRandomProducts(products, 3).map((productBD) => {
                                    ...
                                    const shortName = productBD.name.replace("Combo Perfecto: ", "");
                        ...
                        <section className="social-proof-section">
                            ...
                            <p className="social-subtitle">
                                No te quedes sin tu combo perfecto para el Scent Layering. ¡Sumate a la
                                tendencia!
                            </p>
                ...
                <section className="social-proof-section">
                    ...
                    <div className="social-grid">
                        ...
                        <div className="social-card video-card">
                            ...
                            ></iframe>
                            <div className="social-overlay video-overlay">@noeliameendezz</div>
                        </div>
                ...
                <section className="faq-section">
                    ...
                    <div className="faq-container">
                        <div className="faq-item">
                            ...
                            <br />
                            <a href="https://www.tiktok.com/@casaamericanapy7/video/7609327204941483272" target="_blank" rel="noreferrer">
                                <button type="button">
                                    Ver técnica de Scent Layering
                                </button>
                            </a>
                        </div>
                        <div className="faq-item">
